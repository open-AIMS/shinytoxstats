...
laboratory cannot put it in a submission and expect anyone to verify it
years later.
...
runs and actually gives the same answer. That is what makes a graphical
interface acceptable for regulatory work rather than merely convenient.
